...
"""
import builtins
import flwr_modif.proto.node_pb2
import flwr_modif.proto.task_pb2
...
class GetNodesResponse(google.protobuf.message.Message):
    ...
    @property
    def nodes(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[flwr_modif.proto.node_pb2.Node]: ...
    def __init__(self,
        *,
        nodes: typing.Optional[typing.Iterable[flwr_modif.proto.node_pb2.Node]] = ...,
        ) -> None: ...
...
class PushTaskInsRequest(google.protobuf.message.Message):
    ...
    @property
    def task_ins_list(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[flwr_modif.proto.task_pb2.TaskIns]: ...
    def __init__(self,
        *,
        task_ins_list: typing.Optional[typing.Iterable[flwr_modif.proto.task_pb2.TaskIns]] = ...,
        ) -> None: ...
...
class PullTaskResRequest(google.protobuf.message.Message):
    ...
    TASK_IDS_FIELD_NUMBER: builtins.int
    @property
    def node(self) -> flwr_modif.proto.node_pb2.Node: ...
    @property
    def task_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]: ...
    def __init__(self,
        *,
        node: typing.Optional[flwr_modif.proto.node_pb2.Node] = ...,
        task_ids: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
...
class PullTaskResResponse(google.protobuf.message.Message):
    ...
    @property
    def task_res_list(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[flwr_modif.proto.task_pb2.TaskRes]: ...
    def __init__(self,
        *,
        task_res_list: typing.Optional[typing.Iterable[flwr_modif.proto.task_pb2.TaskRes]] = ...,
        ) -> None: ...
